...
filenames = [
    ...
    os.path.join(directory, "images", "MASK_SK658 Slobe ch010066.jpg"),
    os.path.join(directory, "images", "MASK_SK658 Slobe ch010147.jpg"),
    os.path.join(directory, "images", "MASK_SK658 Slobe ch010110.jpg"),
    os.path.join(directory, "images", "MASK_SK658 Slobe ch010130.jpg"),
    os.path.join(directory, "images", "MASK_SK658 Slobe ch010114.jpg"),
]
...
print(colored(
    f'The interpolated point is at the depth (x-coordinate) {interpolate_depth} microns and contains percent white pixels (y-coordinate) {interpolate_point}%.', "green"))
